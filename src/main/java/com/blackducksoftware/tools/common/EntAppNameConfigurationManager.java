...
public interface EntAppNameConfigurationManager {
    ...
    String getAppIdentifierPatternString();

    String getFollowsDescriptionPatternString();

    String getWithoutDescriptionFormatPatternString();

    String getWithDescriptionFormatPatternString();

    int getNumSuffixes();

    String getSuffixPatternString(int suffixIndex);

    Pattern getAppIdentifierPattern();

    Pattern getFollowsDescriptionPattern();

    Pattern getWithoutDescriptionFormatPattern();

    Pattern getWithDescriptionFormatPattern();

    Pattern getSuffixPattern(int suffixIndex);
